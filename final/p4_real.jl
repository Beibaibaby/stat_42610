...
py = plot(time_bins[start_index:end_index], lambda_t_record[start_index:end_index], label="lambda_t", color=:green,left_margin=10mm)
plot!(time_bins[start_index:end_index], lambda_t_2_record[start_index:end_index], label="lambda_t_2", color=:purple,left_margin=10mm)
