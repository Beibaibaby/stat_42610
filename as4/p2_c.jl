...
p = plot(alpha_rel_c, average_coherences, xlabel="alpha / alpha_c", ylabel="<m^1(T)>", title="Average Coherence vs. Alpha N=$N", legend=false, left_margin=15mm, bottom_margin=5mm, top_margin=5mm, right_margin=5mm)

# Save the plot to a file
savefig("p2_c_N=$(N).png")